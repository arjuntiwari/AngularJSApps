...
import { DataService } from './Coronavirus/Coronavirus.service';
...
const config = new AuthServiceConfig([
  {
    ...
    provider: new FacebookLoginProvider('2615549981993165')
  }
]);
...
@NgModule({
  ...
  },LocalStorage,SocialUserService,CookieService],
